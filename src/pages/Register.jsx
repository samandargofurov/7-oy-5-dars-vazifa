  ...
  return (
    <>
      <div className="container mx-auto w-2/6">
          <div className="flex flex-col gap-5 mt-2 bg-white py-4 px-6 rounded-lg">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex gap-2 border rounded-lg py-2 px-3">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex gap-2 border rounded-lg py-3 px-3">
                <img src={sms} alt="" />
